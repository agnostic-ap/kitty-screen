...
<p align="center">
  <img src="assets/icon.png" alt="Kitty Screen 应用图标" width="96" />
</p>

## 预览

<p>
  <img src="assets/preview-app.png" alt="Kitty Screen 应用预览" width="720" />
</p>
...
把按顺序生成的绿幕关键帧上传到 Kling AI，生成连续猫咪视频。
...
如果 Kling AI 导出的绿幕颜色和脚本当前 key color 不接近，需要调整 `scripts/green-screen-to-webm.mjs` 里的 `keyColor`、`similarity` 和 `blend` 常量。
